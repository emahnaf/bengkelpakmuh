...
<html>
    ...
    <body>
        <a href="#edit-pelanggan" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-pelanggan" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.pelanggan}" method="PUT">
                <g:hiddenField name="version" value="${this.pelanggan?.version}" />
                <fieldset class="form">
                    <f:all bean="pelanggan"/>
                </fieldset>
